...
contract FakeBlockVerifier is IProofVerificationFunction {
    ...
    function verifyCheckpointBlock(bytes calldata /*genesisBlock*/, uint256 /*chainId*/, bytes32 /*checkpointHash*/, uint32 /*epochLength*/) external pure override returns (address[] memory initialValidatorSet, uint64 epochNumber) {
        return (initialValidatorSet, epochNumber);
    }
